                  ...
                  <div className="card tradecard rightsideHeight">
                    <div className="card-body p-2 h-100">
                      <div className="d-flex">
                        <div className="fs-14 fw-400">Order Book</div>
                      </div>
                      <div className="mt-2 h-100">
                        <div className="mytradetabsIcon">
                          ...
                          <TabContent activeTab={activeTab2}>
                            ...
                            <TabPane tabId="2">tab 2 content here</TabPane>
                            <TabPane tabId="3">tab 3 content here</TabPane>
                          </TabContent>
                        </div>
                      </div>
                    </div>
                            ...
                            <div className="position-relative pt-3">
                              <div className="row">
                                <div className="col-md-6">
                                  <div className="mb-3">
                                    <div
                                      className="btn btn-buy btn-block lh-26"
                                      type="button"
                                    >
                                      Buy
                                    </div>
                                  ...
                                  <div className="fs-12 fw-500 text-center my-2">
                                    Fee : 0.000214 USDT
                                  </div>
                                  <div>
                                    <button
                                ...
                                <div className="col-md-6">
                                  <div className="mb-3">
                                    <div
                                      className="btn btn-sell btn-block lh-26"
                                      type="button"
                                    >
                                      Sell
                                    </div>
