...
// import Changepassword from './views/pages/forgotpassword/Forgotpassword'
...
const RegisterList= React.lazy(()=>import('./views/pages/registerlist/RegisterList'))
const Widgets = React.lazy(() => import('./views/widgets/Widgets'))

const routes = [
  { path: '/', exact: true, name: 'Home' },
  { path: '/registerlist',  name: 'RegisterList' ,element: RegisterList },
